...
module.exports = {
  ...
  create: (context) => ({
    JSXOpeningElement: (node) => {
      const inputComponents = (context.options[0] && context.options[0].inputComponents) || [];
      ...
      const inputType = getPropValue(getProp(node.attributes, "type")) || "text";
      ...
      context.report(node, `'${nodeName}' elements of type '${inputType}' must have an autoComplete attribute`);
    },
  }),
};
