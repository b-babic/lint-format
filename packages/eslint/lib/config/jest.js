module.exports = {
  ...
  plugins: ["jest", "jest-formatting", "@progressivestudio"],
  ...
  rules: {
    ...
    "jest/valid-title": [
      "error",
      {
        disallowedWords: ["correct", "appropriate", "properly", "should", "every", "descriptive"],
      },
    ],
    ...
    "@progressivestudio/jest/no-snapshots": "error",
  },
};
