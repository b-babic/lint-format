module.exports = {
  plugins: ["@progressivestudio", "eslint-comments"],
  ...
  rules: {
    ...
    "@progressivestudio/binary-assignment-parens": ["error", "always"],
    // Prevent images from being directly imported
    "@progressivestudio/images-no-direct-imports": "error",
    // Disallow jest allMocks methods.
    "@progressivestudio/jest/no-all-mocks-methods": "off",
    ...
    "@progressivestudio/no-ancestor-directory-import": "off",
    // Disallow the use of debugger (without fixer to prevent autofix on save in editors)
    "@progressivestudio/no-debugger": "error",
    // Prevent namespace import declarations
    "@progressivestudio/no-namespace-imports": "off",
    // Prevent the usage of unnecessary computed properties.
    "@progressivestudio/no-useless-computed-properties": "error",
    // Prefer early returns over full-body conditional wrapping in function declarations.
    "@progressivestudio/prefer-early-return": ["error", { maximumStatements: 1 }],
    // Prefer that screaming snake case variables always be defined using `const`, and always appear at module scope.
    "@progressivestudio/prefer-module-scope-constants": "error",
    // Restrict the number of returned items from React hooks.
    "@progressivestudio/react-hooks-strict-return": "off",
    // Require input elements to have autocomplete values
    "@progressivestudio/react-require-autocomplete": "off",
    // Prevent importing the entirety of a package.
    "@progressivestudio/restrict-full-import": "off",
    // Prevent module imports between components.
    "@progressivestudio/strict-component-boundaries": "error",
    // Enforces all TypeScript enums to be in pascal case
    "@progressivestudio/typescript/prefer-pascal-case-enums": "off",
    // Enforces all TypeScript enums to be singular
    "@progressivestudio/typescript/prefer-singular-enums": "off",
    // Require that all dynamic imports contain a `webpackChunkName` comment.
    "@progressivestudio/webpack/no-unnamed-dynamic-imports": "off",
