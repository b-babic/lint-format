module.exports = {
  extends: ["plugin:@progressivestudio/esnext", "plugin:import/typescript"],
  ...
  overrides: [
    {
      ...
      rules: {
        ...
        strict: "off",
        "@progressivestudio/prefer-early-return": "off",
        "array-callback-return": "off",
        "getter-return": "off",

        // Prefer TypeScript enums be defined using Pascal case
        "@progressivestudio/typescript/prefer-pascal-case-enums": "error",
        // Prefer TypeScript enums be defined using singular names
        "@progressivestudio/typescript/prefer-singular-enums": "error",
      },
    },
  ],
};
