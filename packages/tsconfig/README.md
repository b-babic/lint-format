# `@progressivestudio/ts-config`

[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](../../LICENSE.md) [![npm version](https://badge.fury.io/js/%40progressivestudio%2Fts-config.svg)](https://badge.fury.io/js/%40progressivestudio%2Fts-config.svg)
...
```bash
$ pnpm add --dev @progressivestudio/ts-config
```
...
```json
{
  "extends": "@progressivestudio/ts-config/application.json",
  "compilerOptions": {
    "baseUrl": ".",
    "rootDir": ".",
    "paths": {"*": ["*", "app/*"]}
...
```json
{
  "extends": "@progressivestudio/ts-config/library.json",
  "compilerOptions": {
    "baseUrl": "./src",
    "rootDir": "."
  },
...
```json
{
  "extends": "@progressivestudio/ts-config/dom.json",
  "compilerOptions": {
    "baseUrl": ".",
    "rootDir": "."
  }
...
```json
{
  "extends": "@progressivestudio/ts-config/base.json",
  "compilerOptions": {
    "baseUrl": ".",
    "rootDir": "."
  }
